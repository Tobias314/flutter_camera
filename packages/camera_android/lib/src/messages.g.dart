...
class CameraApi {
  ...
  Future<void> startChunkableVideoRecording() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camera_android.CameraApi.startChunkableVideoRecording$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
